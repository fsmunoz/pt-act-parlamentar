...
# # A XIII Legislatura: o princípio
...
max_date=l14_min_date - timedelta(1)

parties = l13_parties
votes = votes[(votes['data'] <= max_date)]
votes_hm=votes[l13_parties]
...
sns.heatmap(
    ...
    fmt="d",
    cbar_kws={"shrink": 0.8})
plt.title('Iniciativas parlamentares: votos idênticos (não unânimes), XIII Leg.')
